# Copyright (C) 2002-2020 CERN for the benefit of the FASER collaboration
...
# -------------------------------------------------------------------------------------
#  FaserGeoDBInterface : Interface with the geometry DB
# -------------------------------------------------------------------------------------

class FaserGeoDBInterface:
    ...
    def ConnectToDB(self):
        ...
        self.dbSession = svc.connect( 'FASERDD', accessMode = coral.access_ReadOnly )
