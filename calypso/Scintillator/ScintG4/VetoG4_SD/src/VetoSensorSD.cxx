...
VetoSensorSD::VetoSensorSD( const std::string& name, const std::string& hitCollectionName )
...
void VetoSensorSD::Initialize(G4HCofThisEvent *)
{
...
G4bool VetoSensorSD::ProcessHits(G4Step* aStep, G4TouchableHistory* /*ROhist*/)
{
...
void VetoSensorSD::indexMethod(const G4TouchableHistory *myTouch, 
  ...
  station = (stationName == "Veto::VetoStationA" ? 0 : 1 );
