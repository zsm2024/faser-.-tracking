...
/****************************************************************
   Veto Sensitive Detector class
****************************************************************/

#ifndef VETOG4_SD_VETOSENSORSD_H
#define VETOG4_SD_VETOSENSORSD_H
...
class VetoSensorSD : public G4VSensitiveDetector
{
public:
  // Constructor
  ...
  // Destructor
  ~VetoSensorSD() { /* If all goes well we do not own myHitColl here */ }
...
#endif //VETOG4_SD_VETOSENSORSD_H
