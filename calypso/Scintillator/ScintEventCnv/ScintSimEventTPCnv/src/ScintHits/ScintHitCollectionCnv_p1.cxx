...
const double ScintHitCollectionCnv_p1::m_persEneUnit = 1.0e-5;
const double ScintHitCollectionCnv_p1::m_persLenUnit = 1.0e-5;
const double ScintHitCollectionCnv_p1::m_persAngUnit = 1.0e-5;
const double ScintHitCollectionCnv_p1::m_2bHalfMaximum = pow(2.0, 15.0);
...
ScintHitCollection* ScintHitCollectionCnv_p1::createTransient(const ScintHitCollection_p1* persObj, MsgStream &log) {
