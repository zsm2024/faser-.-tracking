...
#ifndef SCINTHITCOLLECTION_P1_H
#define SCINTHITCOLLECTION_P1_H
...
class ScintHitCollection_p1
{
 public:
/// Default constructor
  ScintHitCollection_p1 ();
  //private:
...
inline
ScintHitCollection_p1::ScintHitCollection_p1 () {}
