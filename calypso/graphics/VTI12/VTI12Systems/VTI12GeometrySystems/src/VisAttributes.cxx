...
DetVisAttributes::DetVisAttributes() {
  ...
  
  {
    SoMaterial *material = new SoMaterial;
    material->ambientColor.setValue(0, .157811, .187004);
    material->diffuseColor.setValue(0.5, 0, 0.1);
    material->specularColor.setValue(.915152, .915152, .915152);
    material->shininess.setValue(0.642424);
...
MatVisAttributes::MatVisAttributes() {
  ...
  */
  ...
  }
  {
    ...
    add("Thinabs",m);
    add("Thickabs",m);
    add("_dd_Materials_Ecal_EcalPb",m);
  }
...

  {
    ...
    add("Scintillator",m);
    add("_dd_Materials_Ecal_EcalSc", m);
    add("_dd_Materials_Ecal_EcalFiber", m);
    add("_dd_Materials_Ecal_EcalFiberPb", m);
  }

  {
    ...
    add("Epoxy",m);
    add("_dd_Materials_Ecal_EcalPlasticBC", m);
    add("_dd_Materials_Ecal_EcalPlasticOutFC", m);
  }
