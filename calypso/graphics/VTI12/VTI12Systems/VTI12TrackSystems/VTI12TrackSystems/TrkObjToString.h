...
{
    switch (type){
        // case Veto:              return std::string("Veto RIO_OnTrack");
        // case Trigger:           return std::string("Trigger RIO_OnTrack");
        // case Preshower:         return std::string("Preshower RIO_OnTrack");
        case SCT:               return std::string("SCT RIO_OnTrack");
        // case Ecal:              return std::string("Ecal RIO_OnTrack");
