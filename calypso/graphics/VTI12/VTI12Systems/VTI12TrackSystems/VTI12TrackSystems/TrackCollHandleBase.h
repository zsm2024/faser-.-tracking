...
#include "VTI12TrackSystems/TrackTypes.h"
#include "VTI12TrackSystems/TrackCommonFlags.h"
#include "VTI12TrackSystems/TrackSysCommonData.h"//Not strictly needed
                 //here, but since all
...
public:
  ...
  void update3DObjectsOfAllHandles(bool invalidatePropagatedPoints = false, float maxR = 0.0 ); // maxR being set will override the prop max value from the controller, e.g. for animations
