...
#ifndef VTI12UTILS_VP1SGACCESSHELPER_H
#define VTI12UTILS_VP1SGACCESSHELPER_H
...
public:
  ...
  template <typename T>
  bool retrieve(SG::ConstIterator<T>& begin, SG::ConstIterator<T>& end, bool silent ); //Returns false in case of errors.
...
#include "VTI12Utils/VP1SGAccessHelper.icc"
