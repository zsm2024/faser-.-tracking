...
#include "VTI12Gui/VP1MainWindow.h"

#include "VTI12Gui/VP1ChannelManager.h"
#include "VTI12Gui/VP1TabManager.h"
#include "VTI12Gui/VP1ExecutionScheduler.h"
#include "VTI12Gui/VP1IncomingMessageDialog.h"
#include "VTI12Gui/VP1PluginDialog.h"
#include "VTI12Gui/VP1DockWidget.h"
#include "VTI12Gui/VP1AvailEvents.h"
#include "VTI12Gui/VP1AvailEvtsLocalDir.h"
  ...
  m_edEditor(0)
{
	...
	#ifndef BUILDVP1LIGHT
		connect(pushButton_quicksetup_faser,SIGNAL(clicked()),this,SLOT(quickSetupTriggered()));
	#else
		connect(pushButton_quicksetup_faser,SIGNAL(clicked()),this,SLOT(quickSetupTriggered()));
	#endif
...
void VP1MainWindow::setRunEvtNumber(const int& r, const unsigned long long& e, const unsigned& triggerType, const unsigned& time, const bool& printmessage ) {
	...
	if(printmessage) {
   	...
   	#else
		setWindowTitle("VTI 12 (Virtual TI 12) ["+expandedevtstr+"]");
    	#endif // BUILDVP1LIGHT
...
void VP1MainWindow::quickSetupTriggered()
{
  ...
  QSettings settings("FASER", "VP1Light");
  ...
  if (sender()==pushButton_quicksetup_geometrystudies||sender()==action_quicklaunch_Geometry_studies) {
    ...
    plugfile="libVTI12GeometryPlugin.so";
  ...
  else if (sender()==pushButton_quicksetup_faser||sender()==action_quicklaunch_faser) {
#ifndef BUILDVP1LIGHT
    plugfile="libVTI12FaserPlugin.so";
    channelname="Faser";
    tabname = "Faser";
#else
