...
///////////////////////////////////////////////////////////////////
// CaloHit.h
//   Header file for class CaloHit
///////////////////////////////////////////////////////////////////
// Class for Ecal hits
///////////////////////////////////////////////////////////////////

#ifndef CALOSIMEVENT_CALOHIT_H
#define CALOSIMEVENT_CALOHIT_H
...
public:
  ...
  //
  CaloHit(const HepGeom::Point3D<double> &localStartPosition,
...
inline unsigned int CaloHit::identify() const
{
  return m_ID;
}

inline double CaloHit::energyLoss() const
{
  return (double) m_energyLoss;
}

inline double CaloHit::meanTime() const
{
  return (double) m_meanTime;
}

inline void CaloHit::setMeanTime(float meanTime)
{
  m_meanTime=meanTime;
}

inline const HepMcParticleLink& CaloHit::particleLink() const
{
  return m_partLink;
}
...
inline float hitTime(const CaloHit& hit)
{
