...
///////////////////////////////////////////////////////////////////
// CaloDectorManagerBase.h (was InDetDetectorManager.h)
///////////////////////////////////////////////////////////////////
// (c) ATLAS Detector software
///////////////////////////////////////////////////////////////////

#ifndef CALOREADOUTGEOMETRY_CALODETECTORMANAGERBASE_H
#define CALOREADOUTGEOMETRY_CALODETECTORMANAGERBASE_H
...
namespace CaloDD {
  ...
  typedef std::map<std::string, const void*> RawAlignmentObjects;
    ...
    /** @class CaloDetectorManagerBase
    
        Virtual base class for all Calorimeter detector managers.
    ...
    */
    ...
    public:
      ...
      // Constructor
      CaloDetectorManagerBase(StoreGateSvc * detStore, const std::string & name);
    ...
    private:
      ...
      class LevelInfo {
        ...
        public:
          LevelInfo(): m_level(-1), m_type(CaloDD::global) {};
          LevelInfo(int level, FrameType frame): m_level(level), m_type(frame) {};
        
          int level() const {return m_level;}
          FrameType frame() const {return m_type;} 
          bool isGlobalDelta() const {return m_type == CaloDD::global;}
          bool isLocalDelta() const {return m_type == CaloDD::local;} 
      ...
      //      CaloDD::AlignFolderType getAlignInfo();
      ...
      virtual bool processSpecialAlignment(const std::string & key,
                                           CaloDD::AlignFolderType alignfolder) const = 0;
...
#endif // CALOREADOUTGEOMETRY_CALODETECTORMANAGERBASE_H
