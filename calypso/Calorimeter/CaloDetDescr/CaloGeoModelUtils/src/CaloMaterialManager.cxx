...
#include "CaloGeoModelUtils/CaloMaterialManager.h"
...
CaloMaterialManager::CaloMaterialManager(const std::string& managerName, StoreGateSvc* detStore,
                                           IRDBRecordset_ptr weightTable,
...
CaloMaterialManager::~CaloMaterialManager() {
...
const GeoMaterial*
CaloMaterialManager::getMaterial(const std::string& materialName) {
  return extraScaledMaterial(materialName, getMaterialInternal(materialName));
}

bool
CaloMaterialManager::hasMaterial(const std::string& materialName) const {
...
const GeoMaterial*
CaloMaterialManager::getAdditionalMaterial(const std::string& materialName) const {
  MaterialStore::const_iterator iter;
...
const GeoMaterial*
CaloMaterialManager::getCompositeMaterialForVolume(const std::string& newMatName,
...
const GeoMaterial*
CaloMaterialManager::getMaterial(const std::string& origMaterialName,
                                  double density,
...
const GeoMaterial*
CaloMaterialManager::getMaterialInternal(const std::string& origMaterialName,
                                          double density,
                                          const std::string& newName) {
...
const GeoMaterial*
CaloMaterialManager::getMaterialScaled(const std::string& origMaterialName,
                                        double scaleFactor,
                                        const std::string& newName) {
  return extraScaledMaterial(origMaterialName, newName,
...
const GeoMaterial*
CaloMaterialManager::getMaterialScaledInternal(const std::string& origMaterialName,
                                                double scaleFactor,
                                                const std::string& newName) {
...
bool
CaloMaterialManager::compareDensity(double d1, double d2) const {
...
void
CaloMaterialManager::addWeightMaterial(std::string materialName, std::string materialBase, double weight,
...
void
CaloMaterialManager::addWeightTableOld(IRDBRecordset_ptr weightTable, const std::string& space) {
...
void
CaloMaterialManager::addScalingTable(IRDBRecordset_ptr scalingTable) {
...
const GeoMaterial*
CaloMaterialManager::getMaterialForVolumeLength(const std::string& materialName, double volume, double length,
                                                 const std::string& newName) {
...
const GeoMaterial*
CaloMaterialManager::getMaterialForVolumeLength(const std::string& name,
...
/*
   const GeoMaterial*
   CaloMaterialManager::getMaterial(const std::vector<const GeoMaterial *> & materialComponents,
                  const std::string & newName)
   {
   const GeoMaterial * newMaterial = 0;
   std::vector<double> fracWeight;
   ...
   const GeoMaterial*
   CaloMaterialManager::getMaterial(const std::vector<std::string> & materialComponents,
                  const std::string & newName)
   {
   const GeoMaterial * newMaterial = 0;
...
const GeoMaterial*
CaloMaterialManager::getMaterial(const std::string& name,
                                  const std::vector<std::string>& materialComponents,
...
const GeoMaterial*
CaloMaterialManager::getMaterialInternal(const std::string& name,
                                          const std::vector<std::string>& materialComponents,
                                          const std::vector<double>& fracWeight,
                                          double density) {
  const GeoMaterial* newMaterial = 0;
...
void
CaloMaterialManager::addTextFileMaterials() {
...
CaloMaterialManager::MaterialDef::MaterialDef()
  : m_density(0),
  m_created(false)
{}

CaloMaterialManager::MaterialDef::MaterialDef(const std::string& name, double density)
  : m_name(name),
  m_density(density),
  m_created(false)
{}
...
void
CaloMaterialManager::MaterialDef::addComponent(const std::string& compName, double fraction) {
  m_components.push_back(compName);
  m_fractions.push_back(fraction);
}

double
CaloMaterialManager::MaterialDef::totalFraction() const {
  double sum = 0;
...
const GeoMaterial*
CaloMaterialManager::extraScaledMaterial(const std::string& materialName,
                                          const std::string& newName,
...
const GeoMaterial*
CaloMaterialManager::extraScaledMaterial(const std::string& materialName, const GeoMaterial* origMaterial) {
...
double
CaloMaterialManager::getExtraScaleFactor(const std::string& materialName) {
