...
#ifndef ECALMATERIALMANAGER_H
#define ECALMATERIALMANAGER_H

// EcalMaterialManager. This provides an interface to the CaloMaterialManager which in turn
...
public:
  ...
  EcalMaterialManager(EcalDataBase* db);
...
private:
  ...
  std::unique_ptr<CaloMaterialManager> m_materialManager;
  const GeoMaterial* m_gasMaterial;

};


#endif // ECALMATERIALMANAGER_H
