...
class FaserGeo2G4STParameterisation : public G4VPVParameterisation
{
public:

  FaserGeo2G4STParameterisation(const GeoXF::Function* func,
                           unsigned int copies);

  virtual ~FaserGeo2G4STParameterisation();
...
private:
  ...
  // copied.
  FaserGeo2G4STParameterisation(const FaserGeo2G4STParameterisation&);
  FaserGeo2G4STParameterisation& operator= (const FaserGeo2G4STParameterisation&);
