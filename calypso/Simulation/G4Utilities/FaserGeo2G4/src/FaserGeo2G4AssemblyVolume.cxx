...
unsigned int FaserGeo2G4AssemblyVolume::s_instanceCounter = 0;

// Default constructor
//
FaserGeo2G4AssemblyVolume::FaserGeo2G4AssemblyVolume()
: m_assemblyID( 0 )
{
  InstanceCountPlus();
...
//
void FaserGeo2G4AssemblyVolume::AddPlacedVolume( G4LogicalVolume*  pVolume,
                                        ...
                                        int copyNo, G4String userC) 
{
  ...
  FaserGeo2G4AssemblyTriplet toAdd( pVolume, translation, toStore );
                                        ...
                                        int copyNo, G4String userC) 
{
  ...
  FaserGeo2G4AssemblyTriplet toAdd( pVolume, v, r, isReflection );
  m_triplets.push_back( toAdd );
...
// translation and rotation.
//
void FaserGeo2G4AssemblyVolume::AddPlacedAssembly( FaserGeo2G4AssemblyVolume* pAssembly,
                                          G4ThreeVector&    translation,
                                          G4RotationMatrix* pRotation )
{
  G4RotationMatrix*  toStore  = new G4RotationMatrix;
  ...
  FaserGeo2G4AssemblyTriplet toAdd( pAssembly, translation, toStore );
  m_triplets.push_back( toAdd );
}
                                          ...
                                          G4Transform3D&    transformation )
{
  ...
  FaserGeo2G4AssemblyTriplet toAdd( pAssembly, v, r, isReflection );
  m_triplets.push_back( toAdd );
}
...
// Tanew =  Ta * Ta'
//
void FaserGeo2G4AssemblyVolume::MakeImprint( FaserGeo2G4AssemblyVolume* pAssembly,
                                    ...
                                    G4bool surfCheck )
{
  ...
  ImprintsCountPlus();
  std::vector<FaserGeo2G4AssemblyTriplet> triplets = pAssembly->m_triplets;
  for( unsigned int   i = 0; i < triplets.size(); i++ )
  {
    ...
    {
      G4Exception("FaserGeo2G4AssemblyVolume::MakeImprint(..)",
...
void FaserGeo2G4AssemblyVolume::MakeImprint( G4LogicalVolume*  pMotherLV,
...
unsigned int FaserGeo2G4AssemblyVolume::GetInstanceCount() const
{
  return FaserGeo2G4AssemblyVolume::s_instanceCounter;
}

void         FaserGeo2G4AssemblyVolume::SetInstanceCount( unsigned int value )
{
  FaserGeo2G4AssemblyVolume::s_instanceCounter = value;
}

void         FaserGeo2G4AssemblyVolume::InstanceCountPlus()
{
  FaserGeo2G4AssemblyVolume::s_instanceCounter++;
}

void         FaserGeo2G4AssemblyVolume::InstanceCountMinus()
{
  FaserGeo2G4AssemblyVolume::s_instanceCounter--;
}
