...
#include "FaserGeo2G4AssemblyTriplet.h"
...
public:  // with description
  ...
  FaserGeo2G4AssemblyVolume();
  FaserGeo2G4AssemblyVolume( G4LogicalVolume* volume,
  ...
  void AddPlacedAssembly( FaserGeo2G4AssemblyVolume* pAssembly,
                          G4Transform3D&    transformation);
  //
...
private:
  ...
  void MakeImprint( FaserGeo2G4AssemblyVolume* pAssembly,
...
private:
  ...
  std::vector<FaserGeo2G4AssemblyTriplet> m_triplets;
...
inline
unsigned int FaserGeo2G4AssemblyVolume::GetImprintsCount() const
{
  return m_imprintsCounter;
}

inline
void         FaserGeo2G4AssemblyVolume::SetImprintsCount( unsigned int value )
{
...
inline
void         FaserGeo2G4AssemblyVolume::ImprintsCountPlus()
{
  m_imprintsCounter++;
}

inline
void         FaserGeo2G4AssemblyVolume::ImprintsCountMinus()
{
  m_imprintsCounter--;
}

inline
unsigned int FaserGeo2G4AssemblyVolume::GetAssemblyID() const
{
  return m_assemblyID;
}

inline
void         FaserGeo2G4AssemblyVolume::SetAssemblyID( unsigned int value )
{
  m_assemblyID = value;
}
...
FaserGeo2G4AssemblyVolume::GetVolumesIterator()
{
...
inline
unsigned int FaserGeo2G4AssemblyVolume::TotalImprintedVolumes() const
{
