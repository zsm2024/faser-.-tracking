...
FaserGeo2G4SolidFactory::FaserGeo2G4SolidFactory() :
    AthMessaging("FaserGeo2G4SolidFactory"),
    m_detStore( "StoreGateSvc/DetectorStore", "FaserGeo2G4SolidFactory" )
{
}

G4VSolid *FaserGeo2G4SolidFactory::Build ATLAS_NOT_THREAD_SAFE (const GeoShape* geoShape, std::string name) const
{
