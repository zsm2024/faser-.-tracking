...
#ifndef FASERMCTRUTH_FASERG4EVENTUSERINFO_H
...
class FaserG4EventUserInfo: public G4VUserEventInformation {
public:
        FaserG4EventUserInfo(): G4VUserEventInformation(),m_nrOfPrimaryParticles(0),
