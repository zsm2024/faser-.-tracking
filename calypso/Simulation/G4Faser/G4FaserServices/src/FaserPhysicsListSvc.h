...
#ifndef G4FASERSERVICES_FASERPHYSICSLISTSVC_H
#define G4FASERSERVICES_FASERPHYSICSLISTSVC_H
...
class FaserPhysicsListSvc : public extends<AthService, IPhysicsListSvc>
{
public:
  // Standard constructor and destructor
  FaserPhysicsListSvc(const std::string& name, ISvcLocator* pSvcLocator);
  virtual ~FaserPhysicsListSvc() = default;
